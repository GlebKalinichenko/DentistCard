...
//        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private int numberOfPoints = arrayTicket.length;
        ...
        private void generateValues() {
            for (int i = 0; i < maxNumberOfLines; ++i) {
                for (int j = 0; j < numberOfPoints; ++j) {
                    randomNumbersTab[i][j] = arrayTicket[j];
                }
            }
        }
        ...
        private ColumnChartData generateColumnData() {
            int numSubcolumns = 1;
            int numColumns = arrayTicket.length;
            ...
            for (int i = 0; i < numColumns; ++i) {
                ...
                for (int j = 0; j < numSubcolumns; ++j) {
                    values.add(new SubcolumnValue(arrayTicket[i], ChartUtils.COLOR_GREEN));
                }
        ...
        private class ValueTouchListener implements ComboLineColumnChartOnValueSelectListener {
            ...
            public void onColumnValueSelected(int columnIndex, int subcolumnIndex, SubcolumnValue value) {
                Toast.makeText(getActivity(), "Врач: " + arrayDoctor[columnIndex] + " Кол. пациентов: " + arrayTicket[columnIndex], Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onPointValueSelected(int lineIndex, int pointIndex, PointValue value) {
                Toast.makeText(getActivity(), "Врач: " + arrayDoctor[pointIndex] + " Кол. пациентов:" + arrayTicket[pointIndex], Toast.LENGTH_SHORT).show();
            }
