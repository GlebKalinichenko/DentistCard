    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private void generateData() {
            ...
            for (int i = 0; i < numValues; ++i) {
                SliceValue sliceValue = new SliceValue(arrayTicket[i], ChartUtils.pickColor());
            ...
            if (hasCenterText2) {
                data.setCenterText2("MainActivity (Roboto Italic)");
        ...
        private class ValueTouchListener implements PieChartOnValueSelectListener {
            ...
            public void onValueSelected(int arcIndex, SliceValue value) {
                Toast.makeText(getActivity(), "Врач: " + arrayDoctor[arcIndex] + " Кол. пациентов: " + arrayTicket[arcIndex], Toast.LENGTH_SHORT).show();
            }
