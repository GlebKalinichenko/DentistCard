...
//                    values.add(new PointValue(j, randomNumbersTab[i][j]));
                    values.add(new PointValue(j, arrayTicket[j]));
                }
        ...
        private void toggleCubic() {
            ...
            if (isCubic) {
                ...
                // to (-5, 105).
                // To make this works during animations you should use MainActivity.setViewportCalculationEnabled(false) before
                // modifying viewport.
        ...
        public class ValueTouchListener implements LineChartOnValueSelectListener {
            ...
            public void onValueSelected(int lineIndex, int pointIndex, PointValue value) {
                Toast.makeText(getActivity(), "Врач " + arrayDoctor[pointIndex], Toast.LENGTH_SHORT).show();
            }
    ...
    public class Loader extends AsyncTask<String, String, String[]> {
        ...
        protected void onPostExecute(String[] value) {
            PlaceholderFragment.numberOfPoints = arrayTicket.length;
            getSupportFragmentManager().beginTransaction().add(R.id.container, new PlaceholderFragment()).commit();
        }
    }
}
