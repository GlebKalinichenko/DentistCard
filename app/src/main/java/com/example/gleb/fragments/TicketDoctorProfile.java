 ...
 */
public class TicketDoctorProfile extends Fragment {
    ...
    public String[] arrayParticientLookup;

    public String profile;

    public TicketDoctorProfile(String fullName, int freshTicket, int allTicket, String profile) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        addImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(InsertTicket.PROFILE, "doctor");
                intent.putExtra(InsertTicket.ALLTICKET, allTicket);
                intent.putExtra(InsertTicket.FRESHTICKET, freshTicket);
    ...
    public class Updater extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                json.put("newRegistrationKod", arrayIdRegistration[registrationPosition]);
...
//        }
        ...
        @Override
        protected String[] doInBackground(String... params) {
            String jsonContent = request.makeRequest("http://dentists.16mb.com/SelectLookupQuery/SelectRegistrationParticient.php");

            Log.d(TAG, jsonContent);
            try {
                JSONArray array = new JSONArray(jsonContent);
                arrayIdRegistration = new int[array.length()];
                arrayDateRegistration = new String[array.length()];
                arrayParticientLookup = new String[array.length()];

                for (int i = 0; i < array.length(); i++){
                    JSONObject jObject = array.getJSONObject(i);
                    String particient = jObject.getString("FIO");
                    String registration = jObject.getString("DateRegistration");
                    int idRegistration = jObject.getInt("IdRegistration");

                    arrayDateRegistration[i] = registration;
                    arrayIdRegistration[i] = idRegistration;
                    arrayParticientLookup[i] = particient;
                }
        ...
        @Override
        protected void onPostExecute(String[] value) {
            ArrayAdapter<String> adapterSpinner = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, arrayParticientLookup);
            adapterSpinner.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
