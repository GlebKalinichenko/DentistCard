...
public class InsertParticient extends InsertPattern {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityKodEditText = (EditText) findViewById(R.id.cityKodEditText);
        ...
        insertButton = (Button) findViewById(R.id.insertParticientButton);
    ...
    public class Sender extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String cityKod = cityKodEditText.getText().toString();
