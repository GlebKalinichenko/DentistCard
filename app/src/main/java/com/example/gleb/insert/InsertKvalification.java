    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (profile){
            case "admin":
                ...
                insertButton = (ImageButton) findViewById(R.id.insertKvalificationButton);
                insertButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (kvalificationEditText.getText().toString().equals("")){
                ...
                drawer.withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerOpened(View drawerView) {
                        ...
                        InputMethodManager inputMethodManager = (InputMethodManager) InsertKvalification.this.getSystemService(Activity.INPUT_METHOD_SERVICE);
                        inputMethodManager.hideSoftInputFromWindow(InsertKvalification.this.getCurrentFocus().getWindowToken(), 0);
                    }
                ...
                drawer.withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            Toast.makeText(InsertKvalification.this, InsertKvalification.this.getString(((Nameable) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                        }
                        if (drawerItem instanceof Badgeable) {
                            ...
                            switch (item) {
                                case 2:
                                    Intent intent = new Intent(InsertKvalification.this, Autoresation.class);
                                    startActivity(intent);
                                    Log.d(TAG, "RegistrationProfileActivity");
                                    break;

                                case 3:
                                    Intent chartIntent = new Intent(InsertKvalification.this, ChartActivity.class);
                ...
                drawer.withOnDrawerItemLongClickListener(new Drawer.OnDrawerItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof SecondaryDrawerItem) {
                            Toast.makeText(InsertKvalification.this, InsertKvalification.this.getString(((SecondaryDrawerItem) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                        }
                        return false;
                    }
                });
