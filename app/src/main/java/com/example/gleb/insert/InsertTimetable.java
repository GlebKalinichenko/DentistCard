...
public class InsertTimetable extends InsertPattern {
    ...
    public int[] arrayIdChange;
    public String[] arrayChange;

    public MaterialSpinner doctorSpinner;
    public MaterialSpinner changeSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile = getIntent().getStringExtra(InsertTimetable.PROFILE);

        dateWorkEditText = (EditText) findViewById(R.id.dateWorkEditText);
        insertButton = (ImageButton) findViewById(R.id.insertTimetableButton);

        new LoaderDoctor().execute();
        new LoaderChange().execute();
            ...
            case "registrator":
                ...
                drawer.withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerOpened(View drawerView) {
                        ...
                        InputMethodManager inputMethodManager = (InputMethodManager) InsertTimetable.this.getSystemService(Activity.INPUT_METHOD_SERVICE);
                        inputMethodManager.hideSoftInputFromWindow(InsertTimetable.this.getCurrentFocus().getWindowToken(), 0);
                    }
                ...
                drawer.withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            Toast.makeText(InsertTimetable.this, InsertTimetable.this.getString(((Nameable) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                        }
                        if (drawerItem instanceof Badgeable) {
                            ...
                            switch(item){
                                case 2:
                                    Intent intent = new Intent(InsertTimetable.this, Autoresation.class);
                                    startActivity(intent);
                                    Log.d(TAG, "RegistrationProfileActivity");
                                    break;

                                case 3:
                                    Intent chartIntent = new Intent(InsertTimetable.this, ChartActivity.class);
                ...
                drawer.withOnDrawerItemLongClickListener(new Drawer.OnDrawerItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof SecondaryDrawerItem) {
                            Toast.makeText(InsertTimetable.this, InsertTimetable.this.getString(((SecondaryDrawerItem) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                        }
                        return false;
                    }
                });
    ...
    public class Sender extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                json.put("changeKod", arrayIdChange[changePosition]);
    ...
    public class LoaderChange extends AsyncTask<String, String, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                arrayChange = new String[array.length()];

                for (int i = 0; i < array.length(); i++) {
                    //parse of array
                    JSONObject jObject = array.getJSONObject(i);
                    arrayIdChange[i] = jObject.getInt("IdChange");
                    arrayChange[i] = jObject.getString("Changing");

                    Log.d(TAG, arrayChange[i]);
                }
        ...
        @Override
        protected void onPostExecute(String[] value) {
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(getBaseContext(), android.R.layout.simple_spinner_item, arrayChange);
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            changeSpinner = (MaterialSpinner) findViewById(R.id.changeSpinner);
            changeSpinner.setOnItemSelectedListener(spinnerSelected);
