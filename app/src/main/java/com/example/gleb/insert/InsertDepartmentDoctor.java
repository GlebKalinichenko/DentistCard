 ...
 */
public class InsertDepartmentDoctor extends InsertPattern {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.insert_department_doctor);


        profile = getIntent().getStringExtra(InsertDepartmentDoctor.PROFILE);

        switch (profile){
            case "admin":
                departmentEditText = (EditText) findViewById(R.id.departmentEditText);
                insertButton = (ImageButton) findViewById(R.id.insertDepartmentButton);
                ...
                drawer.withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerOpened(View drawerView) {
                        ...
                        InputMethodManager inputMethodManager = (InputMethodManager) InsertDepartmentDoctor.this.getSystemService(Activity.INPUT_METHOD_SERVICE);
                        inputMethodManager.hideSoftInputFromWindow(InsertDepartmentDoctor.this.getCurrentFocus().getWindowToken(), 0);
                    }
                ...
                drawer.withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            Toast.makeText(InsertDepartmentDoctor.this, InsertDepartmentDoctor.this.getString(((Nameable) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                        }
                        if (drawerItem instanceof Badgeable) {
                            ...
                            switch (item) {
                                case 2:
                                    Intent intent = new Intent(InsertDepartmentDoctor.this, Autoresation.class);
                                    startActivity(intent);
                                    Log.d(TAG, "RegistrationProfileActivity");
                                    break;

                                case 3:
                                    Intent chartIntent = new Intent(InsertDepartmentDoctor.this, ChartActivity.class);
                ...
                drawer.withOnDrawerItemLongClickListener(new Drawer.OnDrawerItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof SecondaryDrawerItem) {
                            Toast.makeText(InsertDepartmentDoctor.this, InsertDepartmentDoctor.this.getString(((SecondaryDrawerItem) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                        }
                        return false;
                    }
                });
    ...
    public class Sender extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            post = new HttpPost("http://dentists.16mb.com/InsertQuery/InsertDepartmentScript.php");
