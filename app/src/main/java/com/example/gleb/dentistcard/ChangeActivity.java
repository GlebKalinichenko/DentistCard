 ...
 */
public class ChangeActivity extends Pattern {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChangeActivity.this, InsertChange.class);
        ...
        drawer.withOnDrawerListener(new Drawer.OnDrawerListener() {
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                InputMethodManager inputMethodManager = (InputMethodManager) ChangeActivity.this.getSystemService(Activity.INPUT_METHOD_SERVICE);
                inputMethodManager.hideSoftInputFromWindow(ChangeActivity.this.getCurrentFocus().getWindowToken(), 0);
            }
        ...
        drawer.withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                if (drawerItem instanceof Nameable) {
                    Toast.makeText(ChangeActivity.this, ChangeActivity.this.getString(((Nameable) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                }
        ...
        drawer.withOnDrawerItemLongClickListener(new Drawer.OnDrawerItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                if (drawerItem instanceof SecondaryDrawerItem) {
                    Toast.makeText(ChangeActivity.this, ChangeActivity.this.getString(((SecondaryDrawerItem) drawerItem).getNameRes()), Toast.LENGTH_SHORT).show();
                }
                return false;
            }
        });
        ...
        rv.addOnItemTouchListener(
                new RecyclerItemClickListener(getBaseContext(), new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        MaterialDialog dialog = new MaterialDialog.Builder(ChangeActivity.this)
